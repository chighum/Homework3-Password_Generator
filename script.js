    ...
    function choosecharacters() {
      ...
      if (
        ...
        function createPassword() {
          ...
          if (whatCharacters.lowerCase) {
            // call for random letter from letters array
          }
          if (whatCharacters.upperCase) {
            // call for random letter from letters.toUpperCase()
          }
          if (whatCharacters.numbers) {
            var randomNum = Math.floor(Math.random() * 10);
          }
          if (whatCharacters.specialCharacters) {
...
var upperCaseLetters = lowerCaseLetters;
